...
// unhides study content on load
  $('.wrap').removeClass('hidden');
  setTimeout(function() { $('.work').removeClass('bgfade'); }, 500);
...
// links and transitions to other pages
  $('body.study').on('mouseup', '.nextstudy', function(event) {
    event.preventDefault();
    var studyPath = '/'+$(this).attr('data-nextstudy')+'/';
    if((event.which == 1)) {
      $('body').addClass('next'); 
